    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="md:w-2/3">
          <h1 className="mb-7 text-3xl md:text-5xl font-bold md:leading-[56px]">
            Explore a Universe of Car Toys and Racing Delights
          </h1>
          <p className="mb-7 px-10">
          ...
          <Link to="/allToys">
            <button className="bg-orange-600 text-lg text-white px-8 py-2 font-bold rounded">
              Explore Toys
            </button>
          </Link>
        </div>
